...
@section('main-content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                <form action="{{ route('pengajuan.update', $datas['id']) }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="user_id" disabled class="form-control" id="userSelect2"></select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="namaUsaha" class="form-control" id="namaUsaha" name="namaUsaha"
                                        value="{{ old('namaUsaha') ? old('namaUsaha') : $datas['namaUsaha'] }}" placeholder="Nama Usaha">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namaPemilik" name="namaPemilik"
                                        value="{{ old('namaPemilik') ? old('namaPemilik') : $datas['namaPemilik'] }}" placeholder="Nama Pemilik">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="alamatUsaha" name="alamatUsaha" placeholder="Alamat Usaha">{{ old('alamatUsaha') ? old('alamatUsaha') : $datas['alamatUsaha'] }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nik" name="nik"
                                        placeholder="NIK" value="{{ old('nik') ? old('nik') : $datas['nik'] }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="kategori" class="form-control" id="kategori" name="kategoriUsaha"
                                        placeholder="Kategori Usaha" value="{{ old('kategoriUsaha') ?: $datas['kategoriUsaha'] }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat" placeholder="Alamat Pemilik Usaha">{{ old('alamat') ?: $datas['alamat'] }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="deskripsiUsaha" name="deskripsiUsaha" placeholder="Deskripsi Produk">{{ old('deskripsiUsaha') ?: $datas['deskripsiUsaha'] }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="omsetPerBulan" name="omsetPerBulan"
                                        value="{{ old('omsetPerBulan') ?: $datas['omsetPerBulan'] }}" placeholder="Omset Per Bulan (Rp)"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="rencanaPengajuan" name="rencanaPengajuan" placeholder="Rencana Penggunaan Dana">{{ old('rencanaPengajuan') ?: $datas['rencanaPengajuan'] }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="jumlahPengajuan"
                                        name="jumlahPengajuan" value="{{ old('jumlahPengajuan') ?: $datas['jumlahPengajuan'] }}"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="persentaseBagiHasil"
                                        name="persentaseBagiHasil" value="{{ old('persentaseBagiHasil') ?: $datas['persentaseBagiHasil'] }}"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="periodeBagiHasil"
                                        value="{{ old('periodeBagiHasil') ?: $datas['periodeBagiHasil'] }}" name="periodeBagiHasil"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
    ...
    @push('scripts')
        ...
        @else
            <script>
                $(document).ready(function() {
                    var uri = '{{ route('users.edit', $datas->user_id) }}';
                    setUserData(uri);
                });
            </script>
        @endif
