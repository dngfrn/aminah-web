                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="" disabled value="{{$datas->user->name}}" id="">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="namaUsaha" class="form-control" id="namaUsaha" name="namaUsaha"
                                        value="{{ $datas->namaUsaha }}" disabled placeholder="Nama Usaha">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namaPemilik" name="namaPemilik"
                                        value="{{ $datas->namaPemilik }}" disabled placeholder="Nama Pemilik">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="alamatUsaha" disabled name="alamatUsaha" placeholder="Alamat Usaha">{{ $datas->alamatUsaha }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="">NIK</label>
                                    <input type="text" class="form-control" id="nik" disabled name="nik"
                                        placeholder="NIK" value="{{ $datas->nik }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="kategori" class="form-control" id="kategori" name="kategoriUsaha"
                                        placeholder="Kategori Usaha" disabled value="{{ $datas->kategoriUsaha }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="alamat" disabled name="alamat" placeholder="Alamat Pemilik Usaha">{{ $datas->alamat }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="deskripsiUsaha" disabled name="deskripsiUsaha" placeholder="Deskripsi Produk">{{ $datas->deskripsiUsaha }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled id="no_telp" value="{{ $datas->user->noTelp }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="omsetPerBulan" name="omsetPerBulan"
                                        value="{{ format_number($datas->omsetPerBulan) }}" disabled placeholder="Omset Per Bulan (Rp)" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" disabled value={{ $datas->user->email }} class="form-control" id="email"
                                        placeholder="Email"> 
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" disabled id="rencanaPengajuan" name="rencanaPengajuan" placeholder="Rencana Penggunaan Dana">{{ $datas->rencanaPengajuan }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="jumlahPengajuan"
                                        name="jumlahPengajuan" disabled value="{{ format_number($datas->jumlahPengajuan) }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="persentaseBagiHasil"
                                        name="persentaseBagiHasil" disabled value="{{ $datas->persentaseBagiHasil }}%" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
