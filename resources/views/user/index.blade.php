            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-12 d-flex justify-content-between">
                        <h4>Data User</h4>
                        <a href="{{ route('users.create') }}" type="button" class="add btn btn-sm btn-primary">Tambah</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <div class="row mb-2 justify-content-end">
                                ...
                                <div class="col-sm-2">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="email" value="{{request('email')}}" placeholder="Search By Email">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="role" value="{{request('role')}}" placeholder="Search By Role">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <tbody>
                                ...
                                @foreach ($datas as $key => $data)
                                    <tr>
                                        ...
                                        <td>{{ @$data->email }}</td>
                                        <td>{{ @$data->role ? ucwords(str_replace("_"," ",$data->role)) : ""  }}</td>
                                        <td>
