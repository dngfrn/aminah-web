    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow">
                <form action="{{ route('pemodal.update', $datas->id) }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="namaLengkap"
                                        value="{{ old('namaLengkap') ? old('namaLengkap') : $datas['namaLengkap'] }}"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="jenisKelamin" id="jenisKelamin" class="form-control">
                                        ...
                                        <option value="Laki - Laki" @if ((old('jenisKelamin') ? old('jenisKelamin') : $datas['jenisKelamin']) == 'Laki - Laki') selected @endif>Laki -
                                            Laki</option>
                                        <option value="Perempuan" @if ((old('jenisKelamin') ? old('jenisKelamin') : $datas['jenisKelamin']) == 'Perempuan') selected @endif>
                                            Perempuan</option>
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" id="alamat" class="form-control">{{ old('alamat') ? old('alamat') : $datas['alamat'] }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    value="{{ old('tempatLahir') ? old('tempatLahir') : $datas['tempatLahir'] }}" aria-describedby="tempatLahir">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tanggalLahir"
                                        value="{{ old('tanggalLahir') ? old('tanggalLahir') : $datas['tanggalLahir'] }}" aria-describedby="tanggalLahir">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pekerjaan"
                                        value="{{ old('pekerjaan') ? old('pekerjaan') : $datas['pekerjaan'] }}" aria-describedby="pekerjaan">
                                    <small id="name" class="form-text text-danger">*Required</small>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="namaBank"
                                        value="{{ old('namaBank') ? old('namaBank') : $datas['namaBank'] }}" aria-describedby="namaBank">
                                    <small id="name" class="form-text text-danger">*Required</small>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="noRekening"
                                        value="{{ old('noRekening') ? old('noRekening') : $datas['noRekening'] }}" aria-describedby="noRekening">
